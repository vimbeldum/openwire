...
import { setDefaultProvider } from '../lib/gifSettings.js';
...
// Re-export AdminPasswordGate from its own file so existing imports still work
export { AdminPasswordGate } from './AdminPasswordGate';
