...
- generic [ref=e4]:
  ...
  - generic "Room and peer context" [ref=e40]:
    ...
    - generic [ref=e55]:
      - generic [ref=e56]: Online (1)
      - generic [ref=e57]:
        - generic [ref=e59]: Alice
        - button "Whisper to Alice" [ref=e60] [cursor=pointer]: 🤫
        - button "Tip Alice" [ref=e61] [cursor=pointer]: 💰
        - button "Poke Alice" [ref=e62] [cursor=pointer]: 👊
    - generic [ref=e64]: Rooms (0)
    - generic [ref=e65]:
      - button "+ Create Room" [ref=e66] [cursor=pointer]
      - button "💀 Dead Drops" [ref=e67] [cursor=pointer]
      - button "✨ Cosmetics Shop" [ref=e68] [cursor=pointer]
```